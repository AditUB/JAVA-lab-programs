...
public class E_list2 {
	
	//Applying loose coupling to create an array list 

	public ArrayList<Employee2> getList()
	{
	...
	public void append(ArrayList al)	
	{
		...
		//this loop runs as long as you enter 'y' oy 'Y' when asked to continue
		do
		{
			...
			Employee2 E=new Employee2(name,xp,sal);
			al.add(E);
